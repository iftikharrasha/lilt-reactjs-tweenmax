...
const Hero = () => {
    ...
    useEffect(() => {
        ...
        const onLoad = () => {
            ...
            TweenMax.from(canRef.current, 1, {
                delay: 0.25,
                opacity: 0,
                y: -800,
                ease: Expo.easeInOut
            ...
            <main id="main" className="main">
                <header className="header" id="header">
                    ...
                    <div className="header__wrap">
                        <a className="logo" href="#lilt" onClick={handleReload} ref={logoRef}>
                ...
                <section className="hero">
                    ...
                    <h1 className="title" ref={titleRef}>LIVE IT UP</h1>
                    <div className="hero__text__callTo">
                        <p ref={subtitleRef}>Sign the petition and let’s save a cultural icon.</p>
                        <button className="main-btn" ref={callToRef}><a href="https://iftikhar-rasha.web.app/" target="_blank" rel="noreferrer">Sign Petition</a></button>
                    </div>
                    </div>
                    <div className="hero__can">
                        <img src={can} alt="can" width="1074" height="716" ref={canRef}/>
                    </div>
                    ...
                    <ul id="scene">
                        <li className="layer" data-depth="-.1">
                            <img src={layer1} alt="layer1" width="144" height="111" ref={layer1Ref}/>
                        </li>
                        <li className="layer" data-depth="-.3">
                            <img src={layer2} alt="layer2" width="144" height="111" ref={layer2Ref}/>
                        </li>
                        <li className="layer" data-depth="-0.75">
                            <img src={layer3} alt="layer3" width="115" height="109" ref={layer3Ref}/>
                        </li>
                        <li className="layer" data-depth=".1"> 
                            <img src={layer4} alt="layer4" width="152" height="233" ref={layer4Ref}/>
                        </li>
                        <li className="layer" data-depth=".3">
                            <img src={layer5} alt="layer5" width="160" height="157" ref={layer5Ref}/>
                        </li>
                        <li className="layer" data-depth="-0.25">
                            <img src={layer6} alt="layer6" width="115" height="121" ref={layer6Ref}/>
                        </li>
                        <li className="layer" data-depth="0.2">
                            <img src={layer7} alt="layer7" width="152" height="233" ref={layer7Ref}/>
                        </li>
                    </ul>
                </div>
